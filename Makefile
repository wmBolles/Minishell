...
#    Updated: 2024/11/29 18:46:47 by wabolles         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c libft/ft_calloc.c libft/ft_isascii.c libft/ft_itoa.c libft/ft_memcpy.c libft/ft_putchar_fd.c libft/ft_putstr_fd.c libft/ft_strdup.c \
		...
		parsing/env.c parsing/expansion.c parsing/send_command.c libft/ft_strcat.c libft/ft_strtrok.c execution/built_in/unset.c parsing/redirections.c \
...
OBJ = $(SRC:.c=.o) parsing/attr_fncs.o
...
$(NAME): $(OBJ)
	$(CC) $(FLAGS) -o $(NAME) $(OBJ) $(READLINE_LIB)
